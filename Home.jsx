  ...
  <p className="fontFam">Featured Product</p>
    ...
    <p className="decorate">Buy Now</p>
     ...
     <div className="Essential">
       ...
       <div className="cont5">
           <img className="l-circle" src="https://img.shop.com/Image/resources/homepage/shop-homepage-icon.svg" alt="/0/"/>
       </div>
       <div className="cont6">
           <h1 style={{textAlign: "left"}}>Hot New Products</h1>
       ...
       <div className="cont9">
           ...
           <div>
            <div className="spring-main2">
                <div className="spring-div" onclick="goPlants()">
...
<div className="cont15">
    ...
    <div className="cont16"> 
        ...
        <div className="clean-div">
            ...
            <p className="k_color" classNams="nw-over">Ultimate Aloe™</p>
            <h2>$27.95</h2>
            <p>+$0.56/2% Cashback</p>
            <p className="j_color">Free shipping with $99 orders</p>
        </div>
